...
import EmployeeIdentityEditorPage from "@/modules/employee_master/pages/EmployeeIdentityEditorPage";
...
jest.mock("@/modules/employee_master/api/employeeIdentityApi", () => ({
  __esModule: true,
  employeeIdentityApi: {
