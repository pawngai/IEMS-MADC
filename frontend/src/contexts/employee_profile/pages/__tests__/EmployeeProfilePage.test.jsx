...
import EssProfilePage from "@/contexts/employee_profile/pages/EmployeeProfilePage";
...
jest.mock("@/contexts/employee_profile/components/EmployeeProfileSummary", () => ({
  __esModule: true,
...
jest.mock("@/contexts/employee_profile/components/EmployeeProfileExtensionEditor", () => ({
  __esModule: true,
...
jest.mock("@/contexts/employee_profile/api/employeeProfileApi", () => ({
  __esModule: true,
  employeeProfileApi: {
