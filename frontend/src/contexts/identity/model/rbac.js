import {
  hasAuthority as hasAuthorityByScope,
  hasAnyAuthority as hasAnyAuthorityByScope,
...
export const normalizeWorkflowStage = (stage) => {
  ...
  return normalized === 'ATTESTED' ? 'LOCKED' : normalized;
};
...
export const hasAuthority = (user, authority) => {
  return hasAuthorityByScope(user, authority);
};

export const hasAnyAuthority = (user, authorities) => {
  return hasAnyAuthorityByScope(user, authorities);
};
