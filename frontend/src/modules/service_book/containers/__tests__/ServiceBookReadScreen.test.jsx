...
jest.mock("@/modules/service_book/containers/ServiceBookLedgerScreen", () => ({
  __esModule: true,
  default: (props) => mockLedgerScreen(props),
}));

jest.mock("@/modules/service_book/containers/ServiceBookPrintScreen", () => ({
  __esModule: true,
...
jest.mock("@/modules/service_book/services/serviceBookDomainService", () => ({
  __esModule: true,
