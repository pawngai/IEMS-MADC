...
import DeptSanctionedStrengthPage from "@/contexts/organization_master/pages/DeptSanctionedStrengthPage";
...
vi.mock("@/contexts/organization_master/hooks/useDepartmentScope", () => ({
  __esModule: true,
  useDepartmentScope: () => ({
...
vi.mock("@/contexts/organization_master/api/departmentApi", () => ({
  __esModule: true,
  departmentPortalAPI: {
...
vi.mock("@/contexts/organization_master/api/mastersApi", () => ({
  __esModule: true,
  mastersAPI: {
