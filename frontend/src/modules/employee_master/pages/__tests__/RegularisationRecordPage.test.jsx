...
import RegularisationRecordPage from "@/modules/employee_master/pages/RegularisationRecordPage";
...
jest.mock("@/modules/employee_master", () => ({
  __esModule: true,
  employeeProfileApi: {
...
jest.mock("@/modules/organization_master", () => ({
  __esModule: true,
  mastersAPI: {
...
jest.mock("@/modules/service_book", () => ({
  __esModule: true,
  serviceRecordsApi: {
