...
import LeaveDashboardPage from "@/contexts/leave_attendance/pages/LeaveDashboardPage";
...
jest.mock("@/contexts/leave_attendance/components/LeaveActionDialog", () => ({
  __esModule: true,
  default: () => null,
}));

jest.mock("@/contexts/leave_attendance/components/LeaveSupportingDocumentsField", () => ({
  __esModule: true,
  default: () => null,
}));
