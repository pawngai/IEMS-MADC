"""Employee Master domain enums.

Canonical merge of employee_identity.schemas.enums and the enum copies in
employee_profile.schemas.profile_model. Values are identical across both old
