...
import DeptDirectoryPage from "@/contexts/department/pages/DeptDirectoryPage";
...
vi.mock("@/contexts/department/hooks/useDepartmentScope", () => ({
  __esModule: true,
  useDepartmentScope: () => ({
...
vi.mock("@/contexts/department/hooks/useDepartmentEmployeeDirectory", () => ({
  __esModule: true,
