...
import ServiceBookRecordsPage from "@/modules/service_book/records/pages/ServiceBookRecordsPage";
...
vi.mock("@/modules/service_book/records/components/ServiceRecordTimeline", () => ({
  __esModule: true,
  default: ({ onAttach }) => (
...
vi.mock("@/modules/service_book/records/components/RecordServiceBookRecordDialog", () => ({
  __esModule: true,
  default: () => null,
}));

vi.mock("@/modules/service_book/records/components/CorrectServiceBookRecordDialog", () => ({
  __esModule: true,
  default: () => null,
}));

vi.mock("@/modules/service_book/records/components/VoidServiceBookRecordDialog", () => ({
  __esModule: true,
  default: () => null,
}));

vi.mock("@/modules/service_book/records/components/AttachDocumentDialog", () => ({
  __esModule: true,
  default: ({ event }) => (
