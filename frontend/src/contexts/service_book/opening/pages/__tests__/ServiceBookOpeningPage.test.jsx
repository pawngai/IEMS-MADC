...
import ServiceBookOpeningPage from "@/contexts/service_book/opening/pages/ServiceBookOpeningPage";
...
vi.mock("@/contexts/service_book/opening/api/serviceBookOpeningApi", () => ({
  __esModule: true,
