...
import WorkflowQueueScreen from "@/contexts/workflow/containers/WorkflowQueueScreen";
...
vi.mock("@/contexts/workflow/hooks/useWorkflowQueueQuery", () => ({
...
vi.mock("@/contexts/workflow/hooks/useWorkflowQueueFilters", () => ({
...
vi.mock("@/contexts/workflow/hooks/useWorkflowQueueActions", () => ({
...
vi.mock("@/contexts/workflow/model/workflowQueueSelectors", () => ({
...
vi.mock("@/contexts/workflow/components/WorkflowQueueFilters", () => ({
  __esModule: true,
  default: () => <div data-testid="workflow-filters" />,
}));

vi.mock("@/contexts/workflow/components/WorkflowQueueBulkActions", () => ({
  __esModule: true,
  default: () => null,
}));

vi.mock("@/contexts/workflow/components/WorkflowKanbanView", () => ({
  __esModule: true,
...
vi.mock("@/contexts/workflow/components/WorkflowTableView", () => ({
  __esModule: true,
...
vi.mock("@/contexts/workflow/components/WorkflowDetailPanel", () => ({
  __esModule: true,
...
vi.mock("@/contexts/workflow/components/workflowQueuePrimitives", () => ({
