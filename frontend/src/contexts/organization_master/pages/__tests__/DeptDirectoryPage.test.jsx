...
import DeptDirectoryPage from "@/contexts/organization_master/pages/DeptDirectoryPage";
...
vi.mock("@/contexts/organization_master/hooks/useDepartmentEmployeeDirectory", () => ({
  __esModule: true,
