...
from contexts.employee_master.profile.application.queries.completion_queries import (
...
from contexts.employee_master.profile.application.policy import DEPARTMENT_SCOPED_ROLES
