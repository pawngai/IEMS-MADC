...
import DocumentManagementPage from "@/contexts/documents/pages/DocumentManagementPage";

const mockDeleteDocument = vi.fn();
const mockUseDocumentsBrowser = vi.fn();

vi.mock("@/contexts/documents/hooks/useDocumentsBrowser", () => ({
  __esModule: true,
  useDocumentsBrowser: (...args) => mockUseDocumentsBrowser(...args),
}));

vi.mock("@/contexts/documents/api/documentsApi", () => ({
  __esModule: true,
  documentsAPI: {
