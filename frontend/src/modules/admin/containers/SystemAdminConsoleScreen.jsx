...
import AdminActionDialogs from "@/modules/admin/components/AdminActionDialogs";
import AdminDetailDialogs from "@/modules/admin/components/AdminDetailDialogs";
import UserManagementTab from "@/modules/admin/components/UserManagementTab";
import RoleManagementTab from "@/modules/admin/components/RoleManagementTab";
import DepartmentRolesTab from "@/modules/admin/components/DepartmentRolesTab";
import PolicyMastersSection from "@/modules/admin/sections/PolicyMastersSection";
import useAdminIdentityDataFetchers from "@/modules/admin/hooks/useAdminIdentityDataFetchers";
import useAdminUserActions from "@/modules/admin/hooks/useAdminUserActions";
import useAdminConsolePermissions from "@/modules/admin/hooks/useAdminConsolePermissions";
import useAdminViewHelpers from "@/modules/admin/hooks/useAdminViewHelpers";
import useAdminConsoleTabs from "@/modules/admin/hooks/useAdminConsoleTabs";
