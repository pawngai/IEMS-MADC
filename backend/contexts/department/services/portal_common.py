...
from contexts.rbac.application.access_control import has_permission
from contexts.rbac.application.authorization_service import DEPARTMENT, resolveScopeAccess
