...
from contexts.employee_master.profile.contracts.dto import EmployeeWorkflowAuditDTO
from contexts.employee_master.profile.domain.constants import (
...
from contexts.employee_master.profile.infrastructure.profile_schema_gateway import (
    validate_contact_details,
    validate_identity_documents,
)
from contexts.identity_access.contracts.access_control import is_owner, require_permissions
