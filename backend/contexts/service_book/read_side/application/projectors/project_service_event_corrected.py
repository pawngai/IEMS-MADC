...
async def project_service_event_corrected(*, repo, payload: dict, event_name: str, source_event_id: str | None = None) -> None:
    ...
    await repo.append_entry(
        ...
        fields_changed=sorted(list((payload or {}).keys())),
