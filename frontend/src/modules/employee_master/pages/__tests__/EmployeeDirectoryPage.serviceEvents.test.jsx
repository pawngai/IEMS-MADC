...
import EmployeeDirectoryPage from "@/modules/employee_master/pages/EmployeeDirectoryPage";
...
jest.mock("@/modules/employee_master/hooks/useEmployeeDirectory", () => ({
  __esModule: true,
...
jest.mock("@/modules/identity_access/api/userManagementApi", () => ({
  __esModule: true,
  userManagementAPI: {
