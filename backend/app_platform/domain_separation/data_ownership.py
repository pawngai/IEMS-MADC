...
COLLECTION_OWNERSHIP: dict[str, str] = {
    ...
    r"^leave_.*": "leave_attendance",
    r"^pay_.*": "pay_benefits",
    r"^payroll_.*": "pay_benefits",
    ...
    r"^departments$": "organization_master",
    r"^department_establishments$": "organization_master",
    r"^department_establishment_logs$": "organization_master",
    r"^audit_logs$": "audit",
