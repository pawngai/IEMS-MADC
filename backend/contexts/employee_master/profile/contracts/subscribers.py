...
``contexts.employee_master.profile.read_model.application.subscribers`` directly.
"""

from __future__ import annotations

from contexts.employee_master.profile.read_model.application.subscribers import (  # noqa: F401
