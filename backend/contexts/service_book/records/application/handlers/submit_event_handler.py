...
class SubmitEventHandler:
    ...
    async def handle(self, *, command: SubmitServiceEventCommand, actor_id: str | None) -> dict:
        payload = validated_payload(name="SubmitServiceEvent", command=command)
        ...
        async def _operation(session):
            ...
            await self._event_publisher.publish(
                name=EventName.SERVICE_EVENT_SUBMITTED.value,
