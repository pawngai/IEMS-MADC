...
import EmployeeFilePage from "@/modules/employee_master/pages/EmployeeFilePage";
...
jest.mock("@/modules/employee_master/components/EmployeeProfileSummary", () => ({
  __esModule: true,
  default: () => <div data-testid="employee-profile-summary">summary</div>,
}));

jest.mock("@/modules/organization_master/api/mastersApi", () => ({
  __esModule: true,
  mastersAPI: {
...
jest.mock("@/modules/employee_master/api/employeeProfileApi", () => ({
  __esModule: true,
  employeeProfileApi: {
...
jest.mock("@/modules/service_book/records/api/serviceRecordsApi", () => ({
  __esModule: true,
  serviceRecordsApi: {
...
jest.mock("@/modules/service_book/api/serviceBookApi", () => ({
  __esModule: true,
  serviceBookAPI: {
