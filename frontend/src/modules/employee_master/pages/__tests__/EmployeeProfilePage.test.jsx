...
import EssProfilePage from "@/modules/employee_master/pages/EmployeeProfilePage";
...
jest.mock("@/modules/employee_master/components/EmployeeProfileExtensionEditor", () => ({
  __esModule: true,
